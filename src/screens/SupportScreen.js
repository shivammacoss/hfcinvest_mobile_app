...
const styles = StyleSheet.create({
  ...
  createBtn: { backgroundColor: '#3b82f6', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, marginTop: 24 },
  ...
  priorityOptionActive: { backgroundColor: '#3b82f6' },
  ...
  adminMessage: { backgroundColor: '#3b82f620', marginRight: 40 },
  messageHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  messageSender: { color: '#3b82f6', fontSize: 12, fontWeight: '600' },
  ...
  sendBtn: { backgroundColor: '#3b82f6', width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center' },
});
